...
describe("Dappazon", () => {
  ...
  describe("Buying Products", () => {
    ...
    beforeEach(async () => {
    // List an item
    transaction = await dappazon.connect(deployer).listProducts(ID, NAME, CATEGORY, IMAGE, COST, RATING, STOCK)
    await transaction.wait()
  ...
  describe("Withdrawing", () => {
    ...
    beforeEach(async () => {
      // List a item
      let transaction = await dappazon.connect(deployer).listProducts(ID, NAME, CATEGORY, IMAGE, COST, RATING, STOCK)
      await transaction.wait()
